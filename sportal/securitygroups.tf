...
resource "aws_security_group" "Ansible_SSH_Access" {
  ...
  ingress {
    ...
    to_port     = 22
    protocol    = "tcp"
    cidr_blocks = ["62.253.83.190/32", "82.11.218.115/32", "82.25.7.144/32", "82.27.144.252/32", "109.73.148.70/32", "185.42.236.254/32", "194.97.8.70/32", "194.97.8.69/32"]
  }
...
resource "aws_security_group" "ops_monitoring" {
  ...
  ingress {
    ...
    to_port     = 80
    protocol    = "tcp"
    cidr_blocks = ["${aws_eip.openvpn_eip.public_ip}/32", "109.73.148.70/32", "62.253.83.190/32", "172.27.224.0/20", "62.253.83.190/32", "81.19.48.109/32"]
  }
